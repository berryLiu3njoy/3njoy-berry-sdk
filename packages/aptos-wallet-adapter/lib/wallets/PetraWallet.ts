...
export class PetraWallet extends AbstractWallet {
  icon = 'https://static.souffl3.com/assets/wallet/petra.svg';
  url =
    'https://chrome.google.com/webstore/detail/petra-aptos-wallet/ejjladinnckdgjemekebdpeokbikhfci';
  name = 'Petra Wallet';
  connecting = false;

  provider = window.petra || window.aptos || null;

  isInstalled = () => !!window.petra || !!window.aptos;
